(() => {
    // Data Shift
    const shiftData = {
        'Cia':  ['P', 'P', 'P', 'S', 'X', 'PS', 'S', 'S', 'P', 'P', 'S', 'PS', 'P', 'X', 'S', 'S', 'P', 'P', 'PS', 'X', 'S', 'S', 'S', 'S', 'P', 'PS', 'S', 'S', 'P', 'P', 'X'],
        ...
        'Agus': ['P', 'P', 'P', 'S', 'S', 'S', 'S', 'X', 'PS', 'P', 'P', 'P', 'S', 'S', 'PS', 'X', 'S', 'S', 'P', 'P', 'P', 'PS', 'X', 'S', 'S', 'P', 'P', 'PS', 'P', 'X', 'S'],
        'Abid': ['S', 'S', 'S', 'P', 'P', 'P', 'P', 'S', 'X', 'S', 'S', 'S', 'P', 'P', 'X', 'PS', 'P', 'P', 'S', 'S', 'S', 'X', 'PS', 'P', 'P', 'S', 'S', 'X', 'S', 'PS', 'P']
    };
